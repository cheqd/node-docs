...
*Figure 4: Overview of Resource and Resource Collection creation ([editable version](https://swimlanes.io/u/UhhnSPK69?rev=4))*
...
![Resource Creation Flow](../../.gitbook/assets/adr008-resource-flow.png)
*Figure 5: Detailed sequence diagram of Resource creation on cheqd ([editable version](https://swimlanes.io/u/hXD1jdxYu?rev=4))*
