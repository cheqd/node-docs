...
From [Cosmos SDK documentation, `distribution` module](https://docs.cosmos.network/main/modules/distribution/03_begin_block.html#reward-to-the-community-pool):
...
More information about fee distribution is available in the [**End Block** section of Cosmos's `distribution` module](https://docs.cosmos.network/main/modules/distribution/03_begin_block.html) documentation.
